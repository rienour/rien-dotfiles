...
When performing the installation/setup is is recommended to utilize a separate directory from the based Neovim installation with the `NVIM_APPNAME` (`:h $NVIM_APPNAME` for more information Neovim) variable.
...
| NVIM_COLORSCHEME | Name of the colorscheme to load for the instance | N/A |
